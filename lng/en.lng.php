...
return [
	...
	'2fa' => [
		...
		'2fa_overview_desc' => 'Here you can activate a two-factor authentication for your account.<br><br>You can either use an authenticator-app (time-based one-time password / TOTP), let froxlor send you an email to your account-address after each successful login with a one-time password, or use a FIDO2 security key / passkey.',
		...
		'2fa_key_removed' => 'Security key removed successfully',
		'2fa_fido2_title' => 'FIDO2 / Passkey',
		'2fa_fido2_desc' => 'Your account is protected with a FIDO2 security key or passkey.<br>You can register multiple keys (e.g. a hardware token and a passkey on your phone). To remove all keys and disable FIDO2, click "Deactivate 2FA".',
		'2fa_fido2_registered_keys' => 'Registered security keys',
		'2fa_fido2_add_key' => 'Register new security key',
		'2fa_fido2_key_name' => 'Key name (optional)',
		'2fa_fido2_key_name_placeholder' => 'e.g. YubiKey 5, iPhone Passkey',
		'2fa_fido2_key_added' => 'Security key registered successfully.',
		'2fa_fido2_confirm_delete' => 'Remove this security key?',
		'type_2fa' => '2FA status',
	],
	'admin' => [
		'overview' => 'Overview',
	...
	'login' => [
		...
		'fido2_prompt' => 'Please use your security key or passkey to complete login.',
		'fido2_verify' => 'Use security key',
		'fido2_cancelled' => 'Authentication was cancelled. Please try again.',
	],
	'mails' => [
		'pop_success' => [
